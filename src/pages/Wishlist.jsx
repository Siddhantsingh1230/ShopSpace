    ...
    <>
      {user ? (
        <>
          ...
          >
            <div className="flex flex-col absolute w-full sm:p-8 overflow-hidden">
              <div>
                {/* Bread crumbs */}
              ...
              <div className="flex flex-col max-sm:gap-2 h-24 w-full justify-center items-center max-sm:m-2 sm:mb-10 text-2xl sm:text-6xl bold">
                <img className="h-12 w-12 sm:h-16 sm:w-16" src={heart} alt=""/>
                <div>My wishlist</div>
              </div>
              ...
              <strong className="max-sm:hidden font-[Montserrat] ">Space Shop</strong>
                {/* Search */}
              ...
              <div className="flex flex-wrap gap-10 p-10 justify-center w-full  overflow-y-scroll ">
                {wishlist.map((i, idx) => (
                  <div
                    key={idx}
